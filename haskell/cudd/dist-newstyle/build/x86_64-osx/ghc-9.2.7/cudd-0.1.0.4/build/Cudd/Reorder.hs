...
--Reordering types
data CuddReorderingType = CuddReorderSame
                        | CuddReorderNone
                        | CuddReorderRandom
                        | CuddReorderRandomPivot
                        | CuddReorderSift
                        | CuddReorderSiftConverge
                        | CuddReorderSymmSift
                        | CuddReorderSymmSiftConv
                        | CuddReorderWindow2
                        | CuddReorderWindow3
                        | CuddReorderWindow4
                        | CuddReorderWindow2Conv
                        | CuddReorderWindow3Conv
                        | CuddReorderWindow4Conv
                        | CuddReorderGroupSift
                        | CuddReorderGroupSiftConv
                        | CuddReorderAnnealing
                        | CuddReorderGenetic
                        | CuddReorderLinear
                        | CuddReorderLinearConverge
                        | CuddReorderLazySift
                        | CuddReorderExact
  deriving (Enum,Show,Eq)

{-# LINE 68 "./Cudd/Reorder.chs" #-}
